namespace LabDataHelper
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// button1
			// 
			button1.Location = new Point(652, 536);
			...
			// button8
			// 
			button8.Location = new Point(646, 393);
			...
			// richTextBox4
			// 
			richTextBox4.Location = new Point(22, 504);
			richTextBox4.Margin = new Padding(4);
			richTextBox4.Name = "richTextBox4";
			richTextBox4.Size = new Size(375, 174);
			...
			// button10
			// 
			button10.Location = new Point(171, 686);
			button10.Margin = new Padding(4);
			button10.Name = "button10";
			button10.Size = new Size(153, 46);
			...
			label6.Location = new Point(21, 786);
			...
			// numericUpDown2
			// 
			numericUpDown2.Location = new Point(93, 782);
			...
			// button11
			// 
			button11.Location = new Point(22, 448);
			...
			comboBox4.Location = new Point(1011, 40);
			comboBox4.Margin = new Padding(4);
			comboBox4.Name = "comboBox4";
			comboBox4.Size = new Size(259, 39);
			...
			label8.Location = new Point(869, 40);
			...
			// textBox1
			// 
			textBox1.Location = new Point(21, 736);
			...
			// numericUpDown3
			// 
			numericUpDown3.Location = new Point(93, 827);
			...
			label9.Location = new Point(21, 829);
